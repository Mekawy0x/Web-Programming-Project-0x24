...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Fetch hotel data
        $stmt = $conn->prepare("SELECT availabe_rooms, price_room FROM hotels WHERE id = ?");
        ...
        $available_rooms = $hotel['availabe_rooms'];
        ...
        $stmt = $conn->prepare("UPDATE hotels SET availabe_rooms = availabe_rooms - ? WHERE id = ?");
